...
print(myDict.get("shweta")) # Returns None as kirankumar is not present in the dictionary
print(myDict["shweta"]) # throws an error as kirankumar is not present in the dictionary